...
export default function RealEstateMosaic() {
  const list: any = {
    visible: {
      transition: {
        when: "beforeChildren",
  ...
  return (
    <div className="w-full px-10 mt-10">
      ...
      >
        {/* ELEMENT 1 VERTICAL 1/2 (ROW 1 & 2) - PHOTOS SERVICE */}
        <motion.div
          variants={item}
        ...
        >
          <h4 className="text-center">Zdjęcia nieruchomości z&nbsp;drona</h4>
          <div className="flex flex-col items-start h-full gap-2 md:gap-0 md:justify-between py-2 md:py-4">
            ...
            <div className="grid grid-cols-3 w-full gap-1">
              <div className="aspect-square relative rounded-md overflow-hidden">
                <Image
                  src="/realEstate/realEstate-4.jpg"
                  fill={true}
                  alt="Photo pack example photo 1"
                  className="h-full object-cover shadow-md"
                />
              </div>
              <div className="aspect-square rounded-md overflow-hidden relative">
                <Image
                  src="/realEstate/realEstate-7.jpg"
                  fill={true}
                  alt="Photo pack example photo 2"
                  className="h-full object-cover shadow-md"
                />
              </div>
              <div className="aspect-square rounded-md overflow-hidden relative">
                <Image
                  src="/realEstate/realEstate-9.jpg"
                  fill={true}
                  alt="Photo pack example photo 3"
                  className="h-full object-cover shadow-md"
                />
              </div>
            </div>
            ...
            <div className="relative w-full">
              <div className="flex w-full aspect-video rounded-md overflow-hidden">
                <div className="relative w-1/2 h-full bg-stone-100">
                  <Image
                    src="/other/slider-1.jpg"
                    fill={true}
                    alt="Lightroom showcase before"
                    className="object-cover h-full float-left object-left"
                  />
                </div>

                <div className="relative w-1/2 h-full bg-stone-100">
                  <Image
                    src="/other/slider-2.jpg"
                    fill={true}
                    alt="Lightroom showcase after"
                    className="object-cover h-full float-right object-right"
                  />
                </div>
              </div>
        ...
        <motion.div
          variants={item}
          className=" h-full aspect-video rounded-xl md:rounded-none shadow-[0_0px_30px_0px_rgba(0,0,0,0.1)] md:shadow-none row-start-2 md:row-start-3 lg:row-start-auto lg:col-start-2 xl:col-start-auto md:aspect-[2/1] md:col-span-2 md:row-span-1 bg-stone-100 w-full overflow-hidden flex justify-center"
        >
          <div className="relative w-full h-full">
            <Image
              src="/realEstate/realEstate-6.jpg"
              fill={true}
              alt="Real estate example photo"
              className="object-cover shadow-md"
            />
          </div>
        </motion.div>

        {/* ELEMENT 3 SQUARE 1/1 (ROW 1) - ORANGE SQUARE */}
        <motion.div
          variants={item}
          className="hidden md:flex md:col-start-1 lg:col-start-1 xl:col-start-auto md:row-start-1 lg:row-start-4 xl:row-start-auto aspect-square col-span-1 row-span-1 xl:bg-gradient-to-br xl:from-accent xl:to-secondary w-full overflow-hidden justify-center"
        >
          <div className="relative w-full h-full">
            <Image
              src="/realEstate/realEstate-5.jpg"
              alt="orange background, real estate"
              fill={true}
              className="object-cover xl:opacity-20 h-full mix-blend-normal md:mix-blend-overlay xl:mix-blend-normal "
            />
          </div>
        </motion.div>

        {/* ELEMENT 4 SQUARE 1/1 (ROW 2) - ORANGE SQUARE */}
        <motion.div
          variants={item}
          className="hidden md:flex md:col-start-1 lg:col-start-auto md:row-start-2 lg:row-start-auto aspect-square col-span-1 row-span-1 bg-gradient-to-br from-accent to-secondary w-full overflow-hidden justify-center"
        >
          <div className="relative w-full h-full">
            <Image
              src="/realEstate/realEstate-2.jpg"
              alt="background real estate photo"
              fill={true}
        ...
        {/* ELEMENT 5 SQUARE 2/2 (ROW 2 & 3) - VIDEO SERVICE */}
        <motion.div
          variants={item}
        ...
        >
          <h4 className="text-center">Filmy promujące nieruchomości z drona</h4>
          ...
          <div className="flex flex-col gap-2 justify-between items-start w-full h-full py-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-0 w-full">
              ...
              <div className="flex items-center w-full justify-center">
                <div className="relative w-2/3 h-full aspect-video">
                  <Image
                    src="/realEstate/realEstate-8.jpg"
                    fill={true}
                    alt="Video quality example"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-0 w-full">
              <div className="flex items-center w-full  justify-center row-start-2 md:row-start-auto">
                <div className="relative w-2/3 h-full aspect-video">
                  <Image
                    src="/other/animations-1.jpg"
                    fill={true}
                    alt="Animations showcase"
              ...
              <div className="flex gap-2 items-center justify-start md:justify-center w-full ">
                <Image
                  ...
                  alt="Pointer icon"
                />
                <span>Płynne animacje z informacjami</span>
              </div>
            </div>
              ...
              <div className="flex items-center w-full  justify-center">
                <div className="relative w-2/3 h-full aspect-video">
                  <Image
                    ...
                    fill={true}
                    alt="Davinci resolve timeline screenshot"
                    className="aspect-video w-full rounded-md"
                  />
