  ...
  return (
    <div className="w-full px-10 mt-10">
      <div className="rounded-xl overflow-hidden w-full grid grid-cols-4 shadow-[0_0px_30px_0px_rgba(0,0,0,0.1)]">
        ...
        {/* ELEMENT 3 VERTICAL 1/2 (ROW 2 & 3) -  */}
